...
public class BtnPlus implements Btn {

    private final Runnable action;
    private final boolean locked;

    public BtnPlus(Runnable action, boolean locked) {
        this.action = action;
        this.locked = locked;
    }
